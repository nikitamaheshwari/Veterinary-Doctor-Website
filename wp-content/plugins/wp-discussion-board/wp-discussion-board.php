...
if ( ! defined( 'DB_PLUGIN_VERSION' ) ) {
	define( 'DB_PLUGIN_VERSION', '2.1.1' );
}
// Plugin Root File.
 ...
 */
if( ! function_exists( 'ctdb_start_plugin_tracking' ) ) { 	// Replace function name here
	function ctdb_start_plugin_tracking() { 					// Replace function name
...
add_action( 'init', 'ctdb_start_plugin_tracking' ); 			// Replace function name
